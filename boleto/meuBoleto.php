...
$cidade = $_SESSION['cidadeCliente'];
$estado = $_SESSION['estadoCliente'];

//$sacado = new Agente('Fernando Maia', '023.434.234-34', 'ABC 302 Bloco N', '72000-000', 'Brasília', 'DF');
$sacado = new Agente($nome, $cpf, $endereco, "", $cidade, $estado);
$cedente = new Agente('Distribuidora Alegrense', '02.123.123/0001-11', 'CLS 403 Lj 23', '29500-000', 'Alegre', 'ES');
