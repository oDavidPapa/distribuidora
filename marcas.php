            ...
            <div class="card ">
                <div class="card-body">
                    ...
                    <p class="card-text text-center"><table>
                        <tr>    
                            <td>Tudo começou em Leuven, na Bélgica, em 1366 nasceu a cervejaria. <span style="color:blue; cursor:pointer" onclick="document.getElementById('expandir1').style.display = ''" >Expandir</span></td>
                        </tr>
                        <tr>
                            <td id="expandir1" style="display:none;">E com ela, as bases para a qualidade e o sabor. Ambas características distiguem a Stella Artois até hoje das demais cervejas. Seis séculos depois, essa origem ainda é motivo de orgulho. 
        ...
        <div class="col-sm-2 col-md-2 col-lg-2 my-2">
            <div class="card ">
                <div class="card-body">
                    ...
                    <p class="card-text text-center"><table>
                        <tr>    
                            <td>Em 1886, a Coca-Cola surgia em uma pequena farmácia de Atlanta. <span style="color:blue; cursor:pointer" onclick="document.getElementById('expandir3').style.display = ''" >Expandir</span></td>
                        </tr>
                        <tr>
        ...
        <div class="col-sm-2 col-md-2 col-lg-2 my-2">
            <div class="card ">
                <div class="card-body">
                    ...
                    <p class="card-text text-center"><table>
                        <tr>    
                            <td>Começou quando Joseph, 
                                resolveu fabricar sua própria cerveja. <span style="color:blue; cursor:pointer" onclick="document.getElementById('expandir4').style.display = ''" >Expandir</span>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="col-sm-2 col-md-2 col-lg-2 my-2">
            <div class="card ">
                <div class="card-body">
                    ...
                    <p class="card-text text-center"><table>
                        <tr>    
                            <td>Inspirado em bebidas funcionais, 
                                Dietrich fundou a Red Bull. <span style="color:blue; cursor:pointer" onclick="document.getElementById('expandir5').style.display = ''" >Expandir</span>
                            </td>
                        </tr>
                        <tr>
                            <td id="expandir5" style="display:none;"> Em 1980 criou também a fórmula do Energético Red Bull. Desenvolveu o conceito de marketing exclusivo da Red Bull. Em 1987, no dia 1º de abril, 
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-center"><table>
                        ...
                        <tr>
                            <td id="expandir6" style="display:none;">Ela logo tornou-se tema de conversas na cidade e nos EUA, até alcançar o gosto mundial. Mas a receita por trás do sabor puro e natural da Absolut é bem mais antiga, 
        ...
        <div class="col-sm-2 col-md-2 col-lg-2 my-2">
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-center"><table>
                        <tr>    
                            <td>Fabricada nos EUA desde 1876. Inspirado pela cerveja Pilsner. <span style="color:blue; cursor:pointer" onclick="document.getElementById('expandir7').style.display = ''" >Expandir</span>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <p class="card-text text-center"><table>
                        <tr>    
                            <td>Gallo não é apenas uma palavra em um rótulo. A proibição acabara de terminar. 
                                <span style="color:blue; cursor:pointer" onclick="document.getElementById('expandir8').style.display = ''" >Expandir</span>
                            </td>
                        </tr>
                        <tr>
                            <td id="expandir8" style="display:none;">Ernest e Julio Gallo viajavam pelo país vendendo uvas da vinha da família. 
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-center"><table>
                        ...
                        <tr>
                            <td id="expandir9" style="display:none;">Quando o fundador da do bem™ chegou cansado do trabalho e deu sua tradicional passadinha na sua casa 
        ...
        <div class="col-sm-2 col-md-2 col-lg-2 my-2">
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-center"><table>
                        <tr>    
                            <td>A H2OH se originou nos EUA quando a PepsiCo resolveu lançar um produto.  
                                <span style="color:blue; cursor:pointer" onclick="document.getElementById('expandir10').style.display = ''" >Expandir</span>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="col-sm-2 col-md-2 col-lg-2 my-2">
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-center"><table>
                        <tr>    
                            <td>Situada em Garibaldi no coração da Serra Gaúcha - maior região vitivinícola do Brasil.  
                                <span style="color:blue; cursor:pointer" onclick="document.getElementById('expandir11').style.display = ''" >Expandir</span>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="col-sm-2 col-md-2 col-lg-2 my-2">
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-center"><table>
                        <tr>    
                            <td>Pra começar, o que é "Brassaria"?? Nome complicadis né!!  
                                <span style="color:blue; cursor:pointer" onclick="document.getElementById('expandir12').style.display = ''" >Expandir</span>
                            </td>
                        </tr>
                        <tr>
